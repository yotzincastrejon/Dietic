...
//                .scaleEffect(0.86)
            ...
            LinearGradient(colors: color, startPoint: .topLeading, endPoint: .bottomTrailing)
                .mask(RoundedCorners(color: [.blue], tl: 8, tr: 100, bl: 8, br: 8))
                .shadow(color: color.last!.opacity(0.4), radius: 30, x: 2, y: 4)
...
struct MealCard_Previews: PreviewProvider {
    ...
    static var previews: some View {
        Group {
            MealCard(fastingManager: FastingManager(), color: [Color("OGT"), Color("OGB")], backgroundShadow: Color("OGB"), image: "bread", imageShadow: "EggSandwichShadow", imageShadowAlpha: 0.3, mealPeriod: .breakfast)
                .fixedSize(horizontal: true, vertical: false)
            MealCard(fastingManager: FastingManager(), color: [Color("OGT"), Color("OGB")], backgroundShadow: Color("OGB"), image: "bread", imageShadow: "EggSandwichShadow", imageShadowAlpha: 0.3, mealPeriod: .breakfast)
